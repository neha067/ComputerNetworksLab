/*	=> error checksum using checksum
	=> more reliable than CRC
	*/
// C++ implementation of checksum
// https://www.tutorialspoint.com/assets/questions/media/15760/29.jpg
#include <bits/stdc++.h>
using namespace std;
...
string checkSum(string data, int block_size)
{
	...
	return Ones_complement(result); //ones complement at the end
}
